...
\usepackage{amsmath,amssymb} % на всякий случай для \mathbb и т.п.
\usepackage{booktabs}        % таблицы
\usepackage{tikz}            % рисунок в TikZ
% \usepackage{siunitx}       % опционально для выравнивания чисел
...
\usepackage{enumitem} % ← вот это нужно
